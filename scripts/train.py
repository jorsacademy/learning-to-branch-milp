...
from ltb_milp.training import train_branching_model


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train an MLP to imitate strong branching scores.")
...
def main() -> None:
    ...
    print(f"dataset={args.dataset} samples={len(dataset.targets)} final_loss={history[-1]:.6f}")
